...
if (isset($_POST['btnsubmitbooking'])) {
    ...
    if (!isset($_SESSION['GUESTID'])) {
        ...
        $guest->emailaddress     = $_SESSION['email'];
        $guest->age              = $_SESSION['age'];
        $guest->G_CITY           = $_SESSION['city_text'];
        $guest->G_ADDRESS        = $_SESSION['barangay_text'];
        $guest->G_CADDRESS       = $_SESSION['province_text'];
    ...
    $tot = 0; // Initialize $tot outside the loop
    $count_cart = count($_SESSION['monbela_cart']);
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-8 col-sm-4">
                    ...
                    <div class="col-md-12">
                        <label>Address:</label>
                        <?php echo  $_SESSION['barangay_text']. ', ' . $_SESSION['city_text']. ', ' . $_SESSION['province_text']; ?>
                    </div>
                    <div class="col-md-12">
                        <label>Phone #:</label>
