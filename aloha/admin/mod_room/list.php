				  ...
				  <?php 
						...
						echo '<td width="5%" align="center"></td>';
				  		echo '<td align="left"  width="120"><input type="checkbox" name="selector[]" id="selector[]" value="'.$result->ROOMID. '"/> 
				  				<a href="index.php?view=editpic&id='.$result->ROOMID.'"  class="roomImg" title="Click here to Change Image."><img src="'. $result->ROOMIMAGE.'" width="60" height="40" title="'. $result->ROOM .'"/></a></td>';
